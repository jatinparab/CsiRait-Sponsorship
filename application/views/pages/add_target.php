...
?>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Add Target <small>enter details here...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Target Form</h4>
                        </div>
                        <div class="panel-body">
                            <form action="<?php echo base_url()?>Target/addSubmit" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="address" type="text" class="form-control" placeholder="Address input"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="instructions" type="text" class="form-control" placeholder="Default input" />
                                    </div>
                                </div>   
                                <div class="form-group">
